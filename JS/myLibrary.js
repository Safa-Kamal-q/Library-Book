...
function renderMyLibrary(filteredBooks = null) {
                ...
                <div>
                    ...
                    <div class="bt-book">
                        <div class="tooltip" style="margin-top: 0;">
                            ...
                            <svg data-id="${book.id}" xmlns="http://www.w3.org/2000/svg" height="20" width="17.5" viewBox="0 0 448 512" class="mark-read-icon" data-id="${book.id}">
                        ...
                        <div class="view-book" data-id="${book.id}">
...
function setupAddBookForm() {
    ...
    addButton.addEventListener("click", () => {
        formBook.style.display = formBook.style.display === "none" ? "block" : "none";
    });

    submitButton.addEventListener("click", () => {
        const newBook = {
            id: books.length,
            title: document.getElementById("title-book").value,
            description: document.getElementById("desc-book").value,
            author: document.getElementById("author-book").value,
            language: document.getElementById("language-book").value,
            gener: document.getElementById("gener-book").value,
            cover_img: document.getElementById("url-img").value,
            reading_status: false,
        };

        addBook(newBook);
        renderMyLibrary(getBooks());
...
function openModalView(event) {
    const bookId = parseInt(event.currentTarget.getAttribute("data-id"));
