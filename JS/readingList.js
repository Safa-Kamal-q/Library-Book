                ...
                <div class="content-book">
                   ...
                   <div class="bt-book" data-id=${book.id}>
                        <div class="tooltip">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 576 512" class="mark-unread-icon" data-id="${book.id}">
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector(".books-card").addEventListener("click", (event) => {
        const iconClicked = event.target.closest('.mark-unread-icon');

        if (iconClicked) {
            const bookId = parseInt(iconClicked.getAttribute("data-id"));
            const userConfirmed = confirm("Are you sure you want to mark this book as unread?");
